---
title:  5 "Пример и схема ответа (Описание API)"
...
{% include image.html file="documenting-api-endpoints/26.png" alt="SendGridExample" %}

А схема ответа на другой вкладке:

{% include image.html file="documenting-api-endpoints/27.png" alt="SendGridSchema" %}
...
{% include image.html file="documenting-api-endpoints/28.png" alt="exampleValue" %}
...
{% include image.html file="documenting-api-endpoints/29.png" alt="schemaSunrise" %}
...
Если информацию заголовка важно включить в пример ответа (поскольку она предоставляет уникальную информацию, отличную от стандартных [кодов состояния](status-error-codes.html)), то ее также надо включить .

<a name="define"></a>
## Нужно ли определять ответ?

Иногда в документации API схема ответа может отсутствовать, поскольку ответы могут показаться самоочевидными или интуитивно понятными. В API Twitter ответы не поясняются (пример [здесь](https://developer.twitter.com/en/docs/accounts-and-users/manage-account-settings/api-reference/get-account-settings)).
...
Если есть возможность добавить подсветку синтаксиса, обязательно нужно делать это. При использовании статического генератора сайтов, например [Jekyll](Jekyll-and-cloudCannon.html) или синтаксис Markdown с [GitHub](Manage-wiki-content.html), можно использовать встроенную подсветку синтаксиса [Rouge](https://github.com/jneen/rouge). Другие статические генераторы сайтов могут использовать [Pygments](http://pygments.org/) или аналогичные расширения.
...
{% include image.html file="documenting-api-endpoints/30.png" alt="tables" %}
...
{% include image.html file="documenting-api-endpoints/31.png" alt="Dropbox API" %}

Другие API будут вкладывать определения ответов для имитации структуры JSON. Вот пример из bit.ly API:

{% include image.html file="documenting-api-endpoints/32.png" alt="bit.ly API" %}
...
{% include image.html file="documenting-api-endpoints/33.png" alt="eBay" %}

Вот документация ответа:

{% include image.html file="documenting-api-endpoints/34.png" alt="eBayResponse" %}
...
{% include image.html file="documenting-api-endpoints/35.png" alt="API Stripe" %}
...
Многие API смоделировали свой дизайн после Stripe. Например, [Slate](https://github.com/lord/slate), [Spectacle](https://github.com/sourcey/spectacle) или [Readme.io](http://readme.io/). Следует ли использовать Дизайн в три колонки с документацией по API? Может быть.
...
{% include image.html file="documenting-api-endpoints/36.png" alt="MYOB" %}
...
{% include image.html file="documenting-api-endpoints/37.png" alt="London" %}

На самом деле, ответ OpenWeatherMap не генерируется динамически, но он так выглядит.

API Citygrid, который мы рассмотрели в разделе [Пример запроса](step4-request-example.html), также динамически генерирует ответы.
...
Мы прошлись по каждому из разделов, теперь взглянем на них вместе в разделе [Собираем все вместе](putt-all-together.html).

[🔙](step4-request-example.html)

[Go next ➡](putt-all-together.html)
