---
title: Документирование новой конечной точки
last_updated: Oct 8, 2019
sidebar: mydoc_sidebar
permalink: new-endpoint.html
...
Давайте перейдем к [Обзору пошагового описания API](api-reference-tutorial-overview.html)  для изучения пяти шагов, которые мы рассмотрим при создании раздела адресного API для этой новой конечной точки.

[🔙](about-third-module.html)

[Go next ➡](api-reference-tutorial-overview.html)
