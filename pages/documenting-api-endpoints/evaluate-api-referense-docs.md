...
{% include note.html content="Названия разделов могут отличаться на разных сайтах API-документации, но обычно они легко узнаваемы." %}
...
3. Создаем [Pull request](Pull-request-workflows.html) и вносим свои изменения в проект.
