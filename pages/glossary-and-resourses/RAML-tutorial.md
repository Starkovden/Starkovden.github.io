---
title: Справочник RAML
last_updated: Oct 10, 2019
sidebar: mydoc_sidebar
permalink: RAML-tutorial.html
folder: glossary-and-resourses
---

RAML расшифровывается как REST API Modeling Language и аналогичен [спецификации OpenAPI](openapi-tutorial-overview.html). RAML поддерживается [Mulesoft](https://www.mulesoft.com/), компанией, предоставляющей полный комплекс услуг API.

> Если документация не публикуется с помощью Mulesoft или другой платформы, которая требует RAML, рекомендуется вместо этого использовать [спецификацию OpenAPI](openapi-tutorial-overview.html). Однако Mulesoft предлагает API-интерфейсы корпоративного уровня для проектирования, управления и развертывания. Если использовать Mulesoft для своего API, лучше использовать RAML для своей спецификации документации.
...
{% include image.html file="glossary-and-resourses/16.png" alt="RAML" %}
...
Ниже приведен пример OpenWeatherMap API (которым мы [пользовались ранее на этом курсе](using-api-scenario.html) ), отформатированный в спецификации RAML. Для конвертации OpenAPI 3.0 в RAML можно воспользоваться [API Transformer](https://www.apimatic.io/transformer). Как видно RAML очень сильно похож на спецификацию OpenAPI.
...
{% include image.html file="glossary-and-resourses/17.png" alt="Anypoint" %}
...
{% include image.html file="glossary-and-resourses/18.png" alt="OpenWeatherMap API" %}
...
{% include image.html file="glossary-and-resourses/19.png" alt="OpenWeather API" %}
...
[🔙](Get-wind-speed-using-Aeris-API.html)

[Go next ➡](API-Blueprint-tutorial.html)
