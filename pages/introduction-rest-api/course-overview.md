...
На этом курсе по созданию документации API, вместо простых разговорах об абстрактных понятиях, мы будем применять практический подход к документированию API. Изучим документацию API на примере использования различных API сервисов прогнозов погоды.
