...
{% include image.html file="introduction-rest-api/27.jpg" alt="calc" caption="Когда нажимаем кнопки, скрытые функции взаимодействуют с другими компонентами и выдают информацию" %}
