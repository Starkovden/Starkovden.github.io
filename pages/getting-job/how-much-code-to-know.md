...
{% include image.html file="getting-job/2.png" alt="diagram" caption="Степень, в которой тех. писатель может публиковать, редактировать и писать, зависит от уровня его технических знаний" %}
